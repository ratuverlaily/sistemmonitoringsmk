  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-1">SISMEN AKADEMIK</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('administrator/kategori') ?>">Kategori Materi Praktikum</a>
            <a class="collapse-item" href="<?php echo base_url('administrator/file') ?>">File Materi Praktikum</a>
            <a class="collapse-item" href="<?php echo base_url('administrator/meteri') ?>">Materi Praktikum</a>
            <!--<a class="collapse-item" href="<?php echo base_url('administrator/mahasiswa') ?>">Data Murid</a>
            <a class="collapse-item" href="<?php echo base_url('administrator/mahasiswa') ?>">Upload Materi Praktikum</a>
            <a class="collapse-item" href="buttons.html">Kirim Materi Ke Virtual</a>
            <a class="collapse-item" href="buttons.html">Hasil Kegiatan Praktikum</a>            
            <a class="collapse-item" href="buttons.html">Cetak Nilai Praktikum</a>-->            
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="blank.html">Galerry</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Ratu Verlaili Erlindriyani</span>
                <img class="img-profile rounded-circle" src="<?php echo base_url("assets/img/gambar.jpg")?>">
              </a>
