  	...
  	<?php foreach($jurusan as $jrs):?>
  		<form method="post" action="<?php echo base_url('administrator/jurusan/update_aksi')?>">
	  		<div class="form-group" >
				...
				<input type="text" name="kode_jurusan" value="<?php echo $jrs->kode_jurusan ?>" class="form-control">				
			</div>

			<div class="form-group">
				<label>Nama Jurusan</label>
				<input type="text" name="nama_jurusan" value="<?php echo $jrs->nama_jurusan ?>" class="form-control">				
			</div>
