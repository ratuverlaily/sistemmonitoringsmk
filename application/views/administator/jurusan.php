<div class="container-fluid">
	<div class="alert alert-success" role="alert">
  	...
  	<?php echo anchor('administrator/jurusan/input','<batton class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i>  Tambah Jurusan</batton>') ?>
  		...
  		<?php $no = 1; 
  			foreach ($jurusan as $jrs) : ?>
  				<tr>
  					...
  					<td width="20px"><?php echo anchor('administrator/jurusan/kirim/'.$jrs->id_jurusan,'<div class="btn btn-sm btn-primary"><i class="far fa-paper-plane"></i></div>') ?></td>
