...
class Matakuliah extends CI_Controller{
	...
	public function index(){
		...
		$this->load->view('administator/Matakuliah',$data);
	...
	public function _rules(){
		$this->form_validation->set_rules('kode_matakuliah','kode prodi','required', ['required' => 'Kode Matakuliah Wajib Diisi']);
	...
	public function detail($kode){
		...
		$this->load->view('templates_administrator/header');
		$this->load->view('templates_administrator/sidebar');
		$this->load->view('administator/matakuliah_detail',$data);
		$this->load->view('templates_administrator/footer');

	}

	public function input(){
		$tmp = $this->matakuliah_model->tampil_data('prodi')->result();

		$data = array(
			'kode_matakuliah' => set_value('kode_prodi'),
			'nama_matakuliah' => set_value('nama_prodi'),
			'sks' => set_value('sks'),
	...
	public function insert_data(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->session->set_flashdata('pesan','<div class="alert alert-warning alert-dismissible fade show" role="alert">Data Matakuliah Berhasil Ditambahkan<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
